...
pub fn print_docs() {
    ...
    println!("{} {}", "contact".bright_purple(), "______");
    println!("{}{} [name (can be partial)]", indentation, "search".bright_purple());
    println!("{}{} [number (can be partial)]", indentation, "reverse-search".bright_purple());
    println!("{}{} [first name] [last name] [phone number w/ no spaces]", indentation, "add".bright_purple());
    println!("{}{} [first name] [last name] [phone number w/ no spaces]", indentation, "edit".bright_purple());
    println!("{}{} [name/part of name]", indentation, "delete".bright_purple());
    println!("{}{} (displays this documentation)", indentation, "help".bright_purple());
