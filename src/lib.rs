...
pub fn print_docs() {
    ...
    println!("{} {}", "contact".purple(), "______");
    println!("{}{} [name (can be partial)]", indentation, "search".purple());
    println!("{}{} [number (can be partial)]", indentation, "reverse-search".purple());
    println!("{}{} [first name] [last name] [phone number w/ no spaces]", indentation, "add".purple());
    println!("{}{} [first name] [last name] [phone number w/ no spaces]", indentation, "edit".purple());
    println!("{}{} [name/part of name]", indentation, "delete".purple());
    println!("{}{} (displays this documentation)", indentation, "help".purple());
